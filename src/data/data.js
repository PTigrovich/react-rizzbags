export const products = [
    {
        ...
        description: 'Hermes Birkin Shoulder 29 in Swift/Broderie leather',
        imageUrl: '/images/item1-1.png',
    },
    {
        id: 2,
        name: 'Birkin Shoulder',
        description: 'Hermes Birkin Shoulder 29 in Evercolor leather',
        imageUrl: '/images/item1-2.png',
    },
    {
        id: 3,
        name: 'Birkin HAC',
        description: 'Hermes Birkin HAC 28 in Epsom leather',
